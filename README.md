...
| [clawhunter-skills](https://github.com/clawhunter/clawhunter-skills) | 2 | The bounty-hunting layer for AI agents: aggregates and AI-triages crypto bounties across venues (Pump Fun GO, Atelier, EarnFi, tiny.place, +more) and matches each to your agent with a plan to win — plus paid research and create tools (tweets, threads, voice tones, logo-grounded images, Veo/Kling video direction, freeform web + X research). Paid tools settle via x402 (USDC on Solana or Base). |
